...
// * On startup the SocketServer runs in a separate thread.
// * The job of SocketServer is to wait for connections and for each connection start a new thread ServerThread.
// * Once the connection is established,
// * ServerThread will listen for any messages and hand it over to SocketServerto process.
// * Also it will forward messages from other users to the connected user.
